      ...
      <article className='faq-container'>
        <section className='introdution-container'>
          ...
          <p>
            ...
            {complements.defaultTitle}? Responderemos todas suas perguntas para
            que possa vender pela internet de forma fácil e profissional.
          </p>
        </section>
        ...
        <p>
          ...
          e-commerce pensada para que micro, pequenas, médias e grandes empresas
          possam criar sua própria loja online autogerenciável, sem a
        ...
        <p>
          ...
          informações e colocar seus produtos à venda. A solução também os ajuda
          a aumentar sua visibilidade por meio de aplicativos e ferramentas de
          marketing online integrados
        </p>
        ...
        <div className='section-container'>
          ...
          <ul>
            <li>
              um endereço de e-mail (para registrar-se e receber notificações);
            </li>
        ...
        <div className='section-container'>
          <h3>
            <strong>
              <span>
                ...
                visitas? O que as pessoas precisam fazer para achar minha loja e
                os meus produtos?
              </span>
            </strong>
          </h3>
          <p>
            ...
            gerar visitas em sua loja. Isto é uma responsabilidade compartilhada
            entre a {complements.defaultTitle} e você.
          </p>
          <p>
          ...
          <p>
            ...
            mais investem na loja terminam obtendo canais muito mais rentáveis.
          </p>
        </div>
        <div className='section-container'>
          <h3>
          ...
          <p>
            Atualmente, a {complements.defaultTitle} pode ser usada Moçambique e
            com o metical como moeda de compra, venda e pagamento de serviços.
          </p>
        </div>
        <div className='section-container'>
          <h3>
          ...
          <p>
            ...
            utilizar o <em>Google Tradutor</em> disponível em seu navegador para
            obter traduções automáticas, caso prefira visualizar em outro idioma
            ainda não suportado.
          </p>
        </div>
        <div className='section-container'>
          <h3>
            <strong>
              <span>
                Eu vendo pelo WhatsApp, Instagram ou Facebook e quero ter minha
                própria loja. Como faço?
              </span>
            </strong>
          </h3>
          <p>
            ...
            com todos esses canais. Por isso, aqui na {complements.defaultTitle}{' '}
            damos a possibilidade de você manter seus produtos conectados com o
            Instagram e Facebook, além de facilitar a comunicação do seu cliente
        ...
        <div className='section-container'>
          ...
          <p>
            ...
            {complements.defaultTitle} você pode abrir uma loja com sua própria
            marca e até pode continuar vendendo pelo de outras plataformas,
            sincronizando seus produtos entre as duas plataformas.
          </p>
        </div>
        ...
        <div className='section-container'>
          ...
          <p>
            ...
            <em>gateways de pagamentos</em> (como o M-PESA), que permitem cobrar
            pelas suas vendas. Mas, você ainda pode cobrar suas vendas de
            maneira manual (offline, do seu jeito) se assim deseja.
          </p>
        </div>
        <div className='section-container'>
          <h3>
          ...
          <p>
            ...
            transações monetárias entre duas pessoas na internet. Para operar
            com elas, você precisará de um e-mail e, se possível, uma conta
            bancária para retirar o dinheiro logo. Alguns desses serviços pedem
            para apresentar alguma documentação ao habilitar a conta.
          </p>
        ...
        <div className='section-container'>
          ...
          <p>
            Sim, claro. Você pode aceitar os pagamentos da maneira que preferir,
            de forma presencial ou pelo gateway de pagamento. Poderá também
            combiná-lo com o cliente e coordenando por e-mail ou telefone os
        ...
        <div className='section-container'>
          ...
          <p>
            Na internet é comum que o comprador fique encarregado dos custos de
            envio. Uma boa forma para cobrar o valor do frete, é incluir a taxa
            de envio no montante do produto.
          </p>
          <p>
            O valor do frete precisa ser é calculado de acordo com a localização
            do seu cliente e o peso da compra.
          </p>
          <p>
        ...
        <div className='section-container'>
          ...
          <p>
            Recomendamos ter uma logística preparada para suas entregas antes de
            realizar a primeira venda. Para isso, o ideal é buscar maneiras de
            fazer envios enquanto ainda estiver montando sua loja.
          </p>
        </div>
