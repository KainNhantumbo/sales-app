...
const TermsOfUse: NextPage = (): JSX.Element => {
  return (
      ...
      <Container>
        <article>
          ...
          <p>
            ...
            direito privado descreve, através deste documento, as regras de uso
            do site <strong>{complements.websiteUrl}</strong> e qualquer outro
            site, loja ou aplicativo operado pelo proprietário.
          </p>
          <p>
          ...
          <p>
            ...
            Uso e a versão mais atualizada da Política de Privacidade de
            Rubymart.
          </p>
          ...
          <p>
            Todos os elementos de Rubymart são de propriedade intelectual da
            ...
            direitos de propriedade intelectual da Rubymart ou de terceiros.
          </p>
          ...
          <p>
            O funcionamento deste website se dá por prazo indeterminado. O
            website no todo ou em cada uma das suas seções, pode ser encerrado,
            suspenso ou interrompido unilateralmente por Rubymart, a qualquer
