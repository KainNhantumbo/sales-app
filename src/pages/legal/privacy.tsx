    ...
    <Layout
      ...
      <Container>
        <article>
          ...
          <p>
            {complements.defaultTitle}, pessoa jurídica de direito privado leva
            a sua privacidade a sério e zela pela segurança e proteção de dados
            de todos os seus clientes, parceiros, fornecedores e usuários do
            site domínio{' '}
          ...
          <p>
            ...
            coletadas por meio da plataforma.
          </p>
          <p>
            AO ACESSAR A PLATAFORMA, ENVIAR COMUNICAÇÕES OU FORNECER QUALQUER
            TIPO DE DADO PESSOAL, VOCÊ DECLARA ESTAR CIENTE COM RELAÇÃO AOS
            TERMOS AQUI PREVISTOS E DE ACORDO COM A POLÍTICA DE PRIVACIDADE, A
            QUAL DESCREVE AS FINALIDADES E FORMAS DE TRATAMENTO DE SEUS DADOS
            PESSOAIS QUE VOCÊ DISPONIBILIZAR NA PLATAFORMA.
          </p>
          <p>
          ...
          <p>
            ...
            você revise a política de privacidade de qualquer site com o qual
            você interaja antes de permitir a coleta e o uso de seus Dados
            Pessoais.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              que regulam o Tratamento de Dados Pessoais, incluindo, porém sem
              se limitar, a Lei Geral de Proteção de Dados Pessoais ("LGPD").
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              Para entrarmos em contato por um número de telefone e/ou endereço
              de e-mail fornecido. Podemos entrar em contato com você
              pessoalmente, por mensagem de voz, através de equipamentos de
              discagem automática, por mensagens de texto (SMS), por e-mail, ou
              por qualquer outro meio de comunicação que seu dispositivo seja
              capaz de receber, nos termos da lei e para fins comerciais
              razoáveis.
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            autoridades fora do país de residência; (d) para aplicar nossos
            Termos e Condições de Uso; (e) para proteger nossas operações; (f)
            para proteger direitos, privacidade, segurança nossos, seus ou de
            terceiros; (g) para detectar e prevenir fraude; (h) permitir-nos
            usar as ações disponíveis ou limitar danos que venhamos a sofrer; e
            (i) de outros modos permitidos por lei.
          </p>
          ...
          <p>
            ...
            qualquer cadastro e envio de Dados Pessoais. No entanto, algumas das
            funcionalidades da loja poderão depender de cadastro e envio de
            Dados Pessoais como concluir a compra/contratação do serviço e/ou a
          ...
          <p>
            ...
            o endereço do site a partir do qual você chegou. Algumas dessas
          ...
          <p>
            ...
            informações anônimas e agregadas sobre como a plataforma é
            usufruída. Durante nossas operações, em certos casos, aplicamos um
            processo de desidentificação ou pseudonimização aos seus dados para
            que seja razoavelmente improvável que você identifique você através
            do uso desses dados com a tecnologia disponível;
          </p>
          <p>
          ...
          <p>
            ...
            nossa empresa, ativo ou capital (incluindo os relativos à falência
          ...
          <p>
            ...
            grupo corporativo das empresas parceiras em todo o mundo de acordo
          ...
          <p>
            ...
            informação. Essas informações podem ser sobre você, suas
            preferências ou seu dispositivo e são usadas principalmente para que
            a plataforma funcione como você espera. As informações geralmente
            não o identificam diretamente, mas podem oferecer uma experiência na
          ...
          <p>
            ...
            coletar seus Dados Pessoais de diversas formas, incluindo, entre
            outros:
          </p>
          <p>
          ...
          <p>
            ...
            navegador, o tempo despendido na plataforma, as páginas visitadas,
            as preferências de idioma, e outros dados de tráfego anônimos. Nós e
            ...
            mais eficiente, e personalizar sua experiência ao utilizar a
            plataforma, assim como para rastreamento online. Também coletamos
            informações estatísticas sobre o uso da plataforma para
            aprimoramento contínuo do nosso design e funcionalidade, para
            entender como a plataforma é utilizada e para auxiliá-lo a
            solucionar questões relativas à plataforma.
          </p>
          <p>
            ...
            computador. Entretanto, isso pode gerar inconvenientes no uso da
            plataforma.
          </p>
          <p>
            ...
            resultantes do funcionamento limitado da plataforma provocado pela
          ...
          <p>
            ...
            para rastrear ações de usuários da plataforma (incluindo
            destinatários de e-mails), medir o sucesso das nossas campanhas de
            marketing e coletar dados estatísticos sobre o uso da plataforma e
            taxas de resposta, e ainda para outros fins não especificados.
            Podemos contratar empresas de publicidade comportamental, para obter
            relatórios sobre os anúncios da plataforma em toda a internet. Para
            isso, essas empresas utilizam cookies, pixel tags e outras
            tecnologias para coletar informações sobre a sua utilização, ou
            sobre a utilização de outros usuários, da nossa plataforma e de site
            de terceiros. Nós não somos responsáveis por pixel tags, cookies e
          ...
          <p>
            ...
            disposto em lei; (v) portabilidade de Dados Pessoais a outro
            prestador de serviços, contanto que isso não afete nossos segredos
            industriais e comerciais; (vi) eliminação de Dados Pessoais tratados
            com seu consentimento, na medida do permitido em lei; (vii)
            informações sobre as entidades às quais seus Dados Pessoais tenham
            sido compartilhados; (viii) informações sobre a possibilidade de não
            fornecer o consentimento e sobre as consequências da negativa; e
            (ix) revogação do consentimento. Os seus pedidos serão tratados com
            especial cuidado de forma a que possamos assegurar a eficácia dos
            seus direitos. Poderá lhe ser pedido que faça prova da sua
          ...
          <p>
            Buscamos adotar as medidas técnicas e organizacionais previstas
          ...
          <p>
            ...
            informe sobre a política de privacidade de cada site visitado ou de
          ...
          <p>
            ...
            texto na plataforma, com a data de revisão atualizada. Podemos
          ...
          <p>
            Sua utilização da plataforma após as alterações significa que
          ...
          <p>
            ...
            Leis de Proteção de Dados, ou resolver quaisquer dúvidas
            relacionadas ao Tratamento de seus Dados Pessoais, favor
            contatar-nos em {complements.email}.
          </p>
        </article>
      </Container>
    </Layout>
