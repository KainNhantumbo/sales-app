      ...
      <article className='code-of-conduct-container'>
        ...
        <div className='resumo'>
          <p>
            ...
            dela). Não toleramos qualquer forma de assédio aos ou dos usuários e
            clientes.
          </p>

          <p>
            Linguagem e imagens sexuais nunca são apropriadas. Os participantes
            que violarem essas regras podem ser sancionados ou expulsos a
            critério dos administradores.
          </p>
        </div>
        ...
        <p>
          ...
          aplica a todos os espaços da {complements.defaultTitle}, tanto online
          quanto offline. Quem infringir este código de conduta poderá ser
          sancionado ou expulso destes espaços a critério do dos administradores
          da plataforma.
        </p>
        ...
        <ul>
          <li>
            Comentários ofensivos relacionados a gênero, identidade e expressão
            de gênero, orientação sexual, deficiência, doença mental,
            neuro(a)tipicidade, aparência física, tamanho do corpo, idade, raça
            ou religião;
          </li>
          <li>
          ...
          <li>
            Incitação à violência contra qualquer indivíduo, incluindo encorajar
            uma pessoa a cometer suicídio ou se automutilar;
          </li>
          <li>Intimidação deliberada;</li>
          <li>Perseguir ou seguir;</li>
          <li>
            Fotografia ou gravação de assédio, incluindo registro de atividades
            online para fins de assédio;
          </li>
          ...
          <li>
            ...
            pessoa sem seu consentimento, exceto quando necessário para proteger
            pessoas vulneráveis ​​de abuso intencional;
          </li>
        ...
        <h2>
          ...
          marginalizadas em detrimento do conforto das pessoas privilegiadas e,
          portanto, não iremos agir sobre reclamações relacionadas a:
        </h2>
        <ul>
          <li>
          ...
          <li>
            Comunicação razoável de limites, como "me deixe em paz", "vá embora"
            ou "não estou discutindo isso com você";
          </li>
        ...
        <p>
          ...
          uma resposta que se julgue necessária e adequada às circunstâncias. A
          equipe do projeto é obrigada a manter a confidencialidade em relação
          ao relator de um incidente. Mais detalhes sobre políticas de execução
          específicas podem ser publicados separadamente.
        </p>
